...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_d,                  spawn,          {.v = dmenucmd } },                                // open app launcher MOD+r
	{ MODKEY,                       XK_Return,             spawn,          {.v = termcmd } },                                 // spawn terminal MOD+return
	{ MODKEY,             					XK_w,                  spawn,          SHCMD("brave") },
	{ MODKEY,												XK_BackSpace,  				 spawn,          {.v = (const char*[]){ "sysact", NULL } } },
	{ MODKEY|ShiftMask,             XK_c,                  spawn,          SHCMD("flameshot gui") },                          // screenshot MOD+Print
	{ MODKEY,			XK_BackSpace,  spawn,                  {.v = (const char*[]){ "sysact", NULL } } },
	...
	{ MODKEY,                       XK_o,                  incnmaster,     {.i = +1 } },                                      // increase windows in master stack MOD+i
	{ MODKEY|ShiftMask,             XK_o,                  incnmaster,     {.i = -1 } },                                      // decrease windows in master stack MOD+d
	...
	{ MODKEY|ShiftMask,             XK_p,                  setcfact,       {.f =  0.00} },                                    // adjust cfact MOD+O
